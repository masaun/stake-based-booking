...
// StakeBasedBooking
import StakeBasedBooking from "./components/StakeBasedBooking/index.js";
    ...
    return (
      <div className={styles.App}>
        <Header />
          ...
          {this.state.route === 'stake-based-booking' && this.renderStakeBasedBooking()} 
        <Footer />
      </div>
    );
  }
